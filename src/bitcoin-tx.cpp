...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Marscoin marscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  marscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded marscoin transaction") + "\n" +
              "  marscoin-tx [options] -create [commands]   " + _("Create hex-encoded marscoin transaction") + "\n" +
              "\n";
