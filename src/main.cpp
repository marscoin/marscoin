...
uint256 hashGenesisBlock("0x06e005f86644f15d2e4c62b59a038c798a3b0816ba58dcc8c91e02ce5a685299");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Marscoin: starting difficulty is 1 / 2^12
...
unsigned int static DarkGravityWave2(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    printf("Inside GravityWave method\n");
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 112000) { DiffMode = 4; }
        }
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x06e005f86644f15d2e4c62b59a038c798a3b0816ba58dcc8c91e02ce5a685299");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0xb9594f964ad5d42bd99edbfaaeeec900cd0f7563a14d90982cf6675df98d7863"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Marscoin: increase each by adding 2 to marscoin's value.
...
void static MarscoinMiner(CWallet *pwallet)
{
    printf("MarscoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running MarscoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MarscoinMiner terminated\n");
        throw;
    }
}

void GenerateMarscoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&MarscoinMiner, pwallet));
}
