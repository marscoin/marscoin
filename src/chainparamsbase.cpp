...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-marsqnet", "Use Mars quantum testnet scaffold network. Equivalent to -chain=marsqnet.", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
    argsman.AddArg("-qdevnet", "Deprecated alias for -marsqnet. Equivalent to -chain=marsqnet.", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
