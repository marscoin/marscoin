...
- Minor fixes:
  - s/Marscoin/Marscoin/ in the Coin Control example
...
- Internal miner added back to Marscoin.  setgenerate now works, although it is generally a bad idea as it is significantly slower than external CPU miners.
...
patch just to match Marscoin 0.8.5.)
