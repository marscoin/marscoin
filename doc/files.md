...
* marscoin.conf: contains configuration settings for marscoind or marscoin-qt
* marscoind.pid: stores the process id of marscoind while running
...
* debug.log: contains debug information and general logging generated by marscoind or marscoin-qt
