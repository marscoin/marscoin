...
allowing somebody to distribute a Marscoin-Qt.app or marscoin-qt-setup.exe with a valid
...
that the marscoin-qt.exe file inside the installer had not been tampered with.
